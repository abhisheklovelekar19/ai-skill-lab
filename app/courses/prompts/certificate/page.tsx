...
export default function PromptsCertificatePage() {
    ...
    const handleGenerateCertificate = (e: React.FormEvent) => {
        ...
        if (learnerName.trim()) {
            ...
            trackEvent('certificate_generated', { course_name: 'prompts' });
        }
    };
                    ...
                    <>
                        <div className="text-center mb-12">
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-8">
                                Congratulations on passing the Prompt Engineering Certification Test! Enter your name to generate your certificate.
                            </p>
                        </div>
                    ...
                    <>
                            ...
                            <div className="text-center space-y-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
                                        has successfully completed the <strong className="text-gray-900 dark:text-white">Prompt Engineering Basics</strong> mini-course and demonstrated proficiency in crafting effective prompts, understanding prompt patterns, and applying best practices for AI interactions.
                                    </p>
                                </div>
                        ...
                        <div className="text-center space-y-4 print:hidden">
                            ...
                            <div className="pt-4">
                                ...
                                >
                                    ← Back to Prompt Engineering Course
                                </Link>
                            </div>
